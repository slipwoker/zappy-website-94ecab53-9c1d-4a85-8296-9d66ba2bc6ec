document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatedElements.length > 0) {
    ...
    animatedElements.forEach(function (el) {
      ...
      const animClass = el.className;
      const animAttr = el.getAttribute('data-animate') || '';

      if (animClass.includes('fade-in-up') || animAttr === 'fade-in-up') {
        el.style.transform = 'translateY(30px)';
      } else if (animClass.includes('fade-in-down') || animAttr === 'fade-in-down') {
        el.style.transform = 'translateY(-30px)';
      } else if (animClass.includes('fade-in-left') || animAttr === 'fade-in-left') {
        el.style.transform = 'translateX(30px)';
      } else if (animClass.includes('fade-in-right') || animAttr === 'fade-in-right') {
        el.style.transform = 'translateX(-30px)';
      } else {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "לחנים בצ'אט משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '94ecab53-9c1d-4a85-8296-9d66ba2bc6ec',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '94ecab53-9c1d-4a85-8296-9d66ba2bc6ec';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '94ecab53-9c1d-4a85-8296-9d66ba2bc6ec';
